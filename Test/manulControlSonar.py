...
import numpy as np
import manulControl as mc

#### GET SONAR CONFIG
scenario = "OpenWater-HoveringImagingSonar" # 在这里更改场景 1.myTank-HoveringImagingSonar2.SimpleUnderwater-HoveringImagingSonar
...
with holoocean.make(scenario) as env:
    while True:
        if 'q' in mc.pressed_keys: # 退出仿真系统
            break
        # filename = './Data/myTank/{}.pkl'.format(index) # 跑不同的仿真环境把数据存储到不同的地方
